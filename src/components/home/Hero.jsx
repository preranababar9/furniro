...
const Hero = () => {
  return (
    ...
    <div className='relative'>
        ...
        <div className='bg-peach lg:h-[56%]  max-md:text-center lg:w-[38%] w-100vw absolute rounded-lg lg:px-12 py-8 max-lg:left-[50%] max-md:left-4 px-4 top-[30%] lg:right-[10%] max-md:right-4 max-lg:right-10'>
