...
const Card = () => {
  return (
    <section className="mt-10 w-full bg-[#FAF3EA]">
      <div className="max-width py-20 flex max-md:flex-col items-center gap-y-20 lg:justify-between  ">
        {card.map((item, index) => (
          <div key={index} className="flex gap-2  max-md:w-full ">
            <img src={item.img} alt="" />
            <div>
              <h4 className="lg:text-2xl text-xl font-regular font-semibold">
                {item.title}
              </h4>
